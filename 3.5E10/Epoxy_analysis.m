...
for rate=13                                                     % Choose the heating rate to import here
    ...
    %data=readmatrix(strcat(chip_number,'_',num2str(experiment_number(rate)),'_Blank_',max_temperature,'_',num2str(heating_rate(rate)),'Kps.txt'));
     data=readmatrix(strcat('3.5E10_',num2str(sampnum),'.txt'));
...
%%
writematrix(M, '3.5E10_heatflow_col.txt');
writematrix(T, '3.5E10_time_col.txt');
%%
writematrix(Tg_mult, 'Tg_35E10.dat')
writematrix(Tg_mult_std, 'Tg_std_35E10.dat')
